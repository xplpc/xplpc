...
class JsonSerializer : Serializer {
    ...
    override fun encodeRequest(functionName: String, vararg params: Param): String {
        try {
            ...
            Log.e("[JsonSerializer : encodeRequest] Error when try to encode data: ${e.message}")
        }
    ...
    override fun encodeFunctionReturnValue(data: Any): String {
        try {
            ...
            Log.e("[JsonSerializer : encodeFunctionReturnValue] Error when try to encode data: ${e.message}")
        }
    ...
    override fun decodeMessage(data: String): Message? {
        try {
            ...
            Log.e("[JsonSerializer : decodeMessage] Error when try to decode data: ${e.message}")
        }
