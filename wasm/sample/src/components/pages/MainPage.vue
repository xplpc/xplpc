<script lang="ts" setup>
    ...
    const defaultResponseMessageForForm =
    ...
    async function onSubmitForm(e: Event) {
        ...
        const request = new Request(
            "sample.login",
            new Param("username", fieldUsername.value),
            new Param("password", fieldPassword.value),
            new Param("remember", fieldRemember.value),
        );
        ...
        <div v-if="wm.isLoaded">
            <div class="text-left">
                ...
                <form @submit="onSubmitForm">
                    <div class="mb-3">
                        <label for="fieldUsername" class="form-label"
                            >Username</label
                        >
                        <input
                            id="fieldUsername"
                    ...
                    <div class="mb-3">
                        <label for="fieldPassword" class="form-label"
                            >Password</label
                        >
                        <input
                            id="fieldPassword"
                    ...
                    <div class="mb-3 form-check">
                        <input
                            id="fieldRemember"
                            v-model="fieldRemember"
                            type="checkbox"
                            class="form-check-input"
                        />
                        <label class="form-check-label" for="fieldRemember"
                            >Remember</label
                        >
                    </div>
                    ...
                    <p class="my-5 text-center">
                        <small
                            id="responseMessageForForm"
                            class="text-center"
                            >{{ responseMessageForForm }}</small
                        >
                    </p>
